  ...
  showModal(modalDialog(
    ...
    HTML("To ensure accurate matching, make sure your datatable meets the following criteria:<br><br>
        ...
        <ul><li>Sample names in columns and Gene identifiers (Gene ID) in rows</li>
            ...
            <li>If only transcripts per million (TPM) data is available matching results might be less accurate</li></ul>
...
observeEvent(input$help_gene, {
  showModal(modalDialog(
    ...
    "We provide 3 geneset options to run dataset comparisons:",
    br(),
    br(),
    strong("all genes:"),
    "compares gene expression profile across all genes in both reference and sample. ",
    br(),
    strong("kidney marker genes:"),
